...
var Browser = {
  ...
  initRemainingListeners: function browser_initRemainingListeners() {
    ...
    this.results.addEventListener('click', this.followLink.bind(this));
     ...
     this.bookmarkTitle.addEventListener('click',
       this.stopPropagation.bind(this));
     this.bookmarkUrl.addEventListener('click',
       this.stopPropagation.bind(this));
     this.bookmarkMenuAddHome.addEventListener('click',
       this.showHomescreenEntrySheet.bind(this));
     this.homescreenTitle.addEventListener('click',
       this.stopPropagation.bind(this));
     this.homescreenUrl.addEventListener('click',
       this.stopPropagation.bind(this));
  ...
  closeMenuWhenClickOutside: function browser_closeActionMenu(actionMenu) {
    window.addEventListener('click', function hideActionMenu(evt) {
  ...
  stopPropagation: function browser_stopPropagation(evt) {
    evt.stopPropagation();
  },

  // Adaptor to show menu while press bookmark star
  showBookmarkMenu: function browser_showBookmarkMenu(evt) {
    evt.stopPropagation();
  ...
  showHomescreenEntrySheet: function browser_showHomescreenEntrySheet(evt) {
    if (!this.currentTab.url)
      return;
    evt.stopPropagation();
