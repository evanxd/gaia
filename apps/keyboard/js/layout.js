  ...
  symbolLayout: {
    ...
    keys: [
      [
        ...
        { value: '®' }, { value: '<' }, { value: '>'}, { value: '«' },
        { value: '»' },
        { value: '⇧', ratio: 0.85, keyCode: KeyEvent.DOM_VK_UP }
      ],
      [
        { value: '⇪', keyCode: KeyEvent.DOM_VK_CAPS_LOCK },
        { value: '§' }, { value: '€' }, { value: '¥' }, { value: '£' },
        { value: '$' }, { value: '¢' }, { value: '\\' }, { value: '=' },
        { value: '⇦', ratio: 0.55, keyCode: KeyEvent.DOM_VK_LEFT },
        { value: '⇩', ratio: 0.85, keyCode: KeyEvent.DOM_VK_DOWN },
        { value: '⇨', ratio: 0.55, keyCode: KeyEvent.DOM_VK_RIGHT }
      ], [
        { value: ';)', keyCode: KeyEvent.DOM_VK_ALT },
        { value: '&nbsp', ratio: 9.9, keyCode: KeyboardEvent.DOM_VK_SPACE },
